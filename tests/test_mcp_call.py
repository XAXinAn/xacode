...
from xacode.client import needs_tool_search_beta
from xacode.conversation import Message, ToolResultBlock
from xacode.mcp.loading_strategy import (
    McpLoadingMode,
    apply_mode,
    decide_mode,
...
from xacode.mcp.tool_wrapper import build_mcp_tool_name, mcp_tool_name_prefix
from xacode.permissions.rules import extract_content
...
from xacode.tools.mcp_call import (
    McpCallParams,
    McpCallTool,
    coerce_by_schema,
    permission_content,
...
class TestLoadingStrategy:
    ...
    def test_env_override(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("XACODE_MCP_LOADING", "dispatch")
...
class TestPermissionContent:
    ...
    def test_rule_matches_by_server_glob(self) -> None:
        from xacode.permissions.rules import evaluate_rules, parse_rule

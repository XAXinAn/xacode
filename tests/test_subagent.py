...
from xacode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from xacode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from xacode.agents.trace import TraceManager, TraceNode
from xacode.agents.task_manager import BackgroundTask, TaskManager
from xacode.agents.notification import format_task_notification, inject_task_notifications
from xacode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".xacode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from xacode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from xacode.tools.agent_tool import AgentToolParams

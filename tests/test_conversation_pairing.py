"""工具调用配对修补测试：悬空 tool_use 补结果、孤儿 tool_result 丢弃、不改动入参。"""
from __future__ import annotations

from xacode.conversation import Message, ToolResultBlock, ToolUseBlock
from xacode.conversation_pairing import INTERRUPTED_TOOL_RESULT, ensure_tool_pairing

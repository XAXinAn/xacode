"""Coordinator 模式测试：团队生命周期内工具白名单保持收窄。"""
...
from xacode.teams.models import resolve_team_dir
from xacode.tools.team_create import TeamCreateTool, TeamCreateParams
from xacode.tools.team_delete import TeamDeleteTool, TeamDeleteParams

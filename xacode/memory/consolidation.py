...
from xacode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from xacode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".xacode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".xacode", "memory")
    ...
    async def _do_consolidation(
        ...
        transcript_dir = os.path.join(self._work_dir, ".xacode", "sessions")
        ...
        checker = PermissionChecker(
            ...
            rule_engine=RuleEngine(
                ...
                project_rules_path=Path(self._work_dir) / ".xacode" / "permissions.yaml",
                local_rules_path=Path(self._work_dir) / ".xacode" / "permissions.local.yaml",
            ),

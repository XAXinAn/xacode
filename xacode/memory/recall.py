"""记忆召回：扫描记忆文件、解析 frontmatter，并挑选与当前任务相关的记忆。"""
...
SELECTOR_SYSTEM_PROMPT = (
    "You are selecting memories that will be useful to XaCode as it processes "
    ...
    "XaCode as it processes the user's query (up to 5). Only include memories "
    ...
    "that are usage reference or API documentation for those tools (XaCode is "

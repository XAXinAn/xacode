"""InstallSkill 工具：从远端安装技能到本地技能目录。"""
...
class InstallSkillTool(Tool):
    """从 URL 下载并安装 skill 到用户全局目录 (~/.xacode/skills/)。
    ...
    description = (
        ...
        "(~/.xacode/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from xacode.skills.install import parse_skill_url, install_skill

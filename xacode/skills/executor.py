"""技能执行：按技能内容构造提示词交给模型，必要时 fork 当前会话。"""
...
from xacode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from xacode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from xacode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent

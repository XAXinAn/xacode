"""Coordinator 模式提示词：系统提示、稀疏提醒与用户上下文的拼装。"""
...
def get_coordinator_system_prompt(agent_catalog: list[tuple[str, str]] | None = None) -> str:
    ...
    return """You are XaCode, an AI assistant that orchestrates software engineering tasks across multiple workers.
...
def get_coordinator_user_context(
    ...
    if worker_tools is None:
        from xacode.agents.tool_filter import IN_PROCESS_TEAMMATE_ALLOWED_TOOLS

...
from xacode.teams.backend_detect import BackendDetectionError, detect_backend
from xacode.teams.mailbox import Mailbox, create_message
...
from xacode.teams.progress import TeammateProgress
from xacode.teams.registry import AgentNameRegistry
from xacode.teams.shared_task import SharedTaskStore
from xacode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from xacode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from xacode.teams.spawn_iterm2 import kill_pane
                kill_pane(pane_id)

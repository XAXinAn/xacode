"""Hook 配置加载与校验：把 config.yaml 的 hooks 段解析成 Hook 对象。"""
from __future__ import annotations

from xacode.hooks.conditions import ConditionParseError, parse_condition
from xacode.hooks.events import LifecycleEvent
from xacode.hooks.models import Action, Hook
